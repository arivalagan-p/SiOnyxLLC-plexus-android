...
public abstract class ImageMatrixCorrector extends MatrixCorrector {
    ...
    public UpdateAspectRatioState updateAspectRatioState;
    /*
     * Overrides
     */
    ...
    protected void updateScaledImageDimensions() {
        try {
            ...
            if (drawable != null) {
                ...
                if (scaledImageHeight == imageView.getHeight()) {
                    this.updateAspectRatioState.updateAspectRatioButtonState();
                    Log.e("TAG", "updateScaledImageDimensions: " + scaledImageHeight + " " + scaledImageWidth);
                }else {
                    this.updateAspectRatioState.enableObserver();
                }
            } else {
    ...
    public void setAspectImageStateChangeCallback(UpdateAspectRatioState aspectImageStateChangeCallback){
        this.updateAspectRatioState = aspectImageStateChangeCallback;
    }
}

interface UpdateAspectRatioState {
    void updateAspectRatioButtonState();
